...
- Name: tests/site-cart-delete.spec.ts >> Site - Delete from Cart >> should clear entire cart by removing all items
- Location: e2e/tests/site-cart-delete.spec.ts:61:7
